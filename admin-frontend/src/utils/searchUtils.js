...
export class SearchEngine {
  ...
  getSimplePinyin(text) {
    // 简化版拼音映射，只处理常用字
    const pinyinMap = {
      '管': 'guan', '理': 'li', '员': 'yuan', '工': 'gong', '部': 'bu', '门': 'men',
      '角': 'jiao', '色': 'se', '权': 'quan', '限': 'xian', '组': 'zu', '织': 'zhi',
      '考': 'kao', '勤': 'qin', '记': 'ji', '录': 'lu', '打': 'da', '卡': 'ka',
      '请': 'qing', '假': 'jia', '申': 'shen', '批': 'pi', '审': 'shen',
      '公': 'gong', '告': 'gao', '通': 'tong', '知': 'zhi', '消': 'xiao', '息': 'xi',
      '流': 'liu', '程': 'cheng', '任': 'ren', '务': 'wu', '待': 'dai', '办': 'ban',
      '报': 'bao', '表': 'biao', '数': 'shu', '据': 'ju', '统': 'tong', '计': 'ji',
      '系': 'xi', '统': 'tong', '设': 'she', '置': 'zhi', '配': 'pei', '备': 'bei',
      '个': 'ge', '人': 'ren', '信': 'xin', '息': 'xi', '资': 'zi', '料': 'liao'
    }
