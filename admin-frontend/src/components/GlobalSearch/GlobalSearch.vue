...
import { adminSearchConfig } from '@/config/searchConfig'
...
// 搜索引擎实例
const searchEngine = new SearchEngine(adminSearchConfig)
...
const addToHistory = (query) => {
  ...
  // 保存到本地存储
  localStorage.setItem('admin-search-history', JSON.stringify(searchHistory.value))
}
