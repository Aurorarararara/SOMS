...
export const employeeSearchConfig = [
  ...
  // 在线会议
  {
    id: 'meeting',
    title: '会议列表',
    titleKey: 'nav.meetingList',
    path: '/meeting',
    icon: 'VideoCamera',
    category: 'meeting',
    categoryKey: 'search.category.meeting',
    keywords: ['会议', 'meeting', '视频', 'video', '在线', '列表'],
    description: '查看和管理会议列表',
    descriptionKey: 'search.desc.meeting'
  },
  {
    id: 'create-meeting',
    title: '创建会议',
    titleKey: 'nav.createMeeting',
    path: '/meeting/create',
    icon: 'VideoCamera',
    category: 'meeting',
    categoryKey: 'search.category.meeting',
    keywords: ['创建', 'create', '会议', 'meeting', '发起', '新建'],
    description: '创建新的在线会议',
    descriptionKey: 'search.desc.createMeeting'
  },
  {
    id: 'join-meeting',
    title: '加入会议',
    titleKey: 'nav.joinMeeting',
    path: '/meeting/join',
    icon: 'VideoCamera',
    category: 'meeting',
    categoryKey: 'search.category.meeting',
    keywords: ['加入', 'join', '会议', 'meeting', '参与', '进入'],
    description: '通过会议号或链接加入会议',
    descriptionKey: 'search.desc.joinMeeting'
  },
...
export const employeeSearchCategories = [
  ...
  { key: 'meeting', label: '在线会议', labelKey: 'search.category.meeting', icon: 'VideoCamera' },
