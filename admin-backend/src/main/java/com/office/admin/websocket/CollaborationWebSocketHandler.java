...
public class CollaborationWebSocketHandler {
    ...
    public Map<String, Object> joinDocument(
        ...
        try {
            ...
            log.info("管理端用户 {} 加入文档 {} 的协同编辑", userName, documentId);
            return joinNotification;
            
        } catch (Exception e) {
            log.error("管理端用户加入协同编辑失败", e);
    ...
    public Map<String, Object> leaveDocument(
        ...
        try {
            ...
            if (session != null) {
                ...
                log.info("管理端用户 {} 离开文档 {} 的协同编辑", session.getUserName(), documentId);
