...
public class TaskServiceImpl extends ServiceImpl<TaskMapper, Task> implements TaskService {
    ...
    public Task updateTask(TaskUpdateRequest request, Long userId) {
        ...
        if (request.getAllowReassign() != null) task.setAllowReassign(request.getAllowReassign());
        if (request.getNotifyOnUpdate() != null) task.setNotifyOnUpdate(request.getNotifyOnUpdate());
    ...
    @Override
    public Map<String, Object> getGlobalTaskStats() {
        return taskMapper.selectGlobalTaskStats();
    }
    
    @Override
    public List<Map<String, Object>> getDepartmentTaskDistribution() {
        return taskMapper.selectDepartmentTaskDistribution();
    }
    
    @Override
    public List<Map<String, Object>> getUserWorkloadRanking(Integer limit) {
